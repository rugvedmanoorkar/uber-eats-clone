    ...
    <div className="qr b6 qs">
      ...
      <div>
        <div className="cw gk">
          <a
            className="ag qp c1"
            href="/checkout?diningMode=DELIVERY&amp;mod=locationManager&amp;ps=1"
          >
            <div className="qf">
              <svg
                aria-hidden="true"
            ...
            <div className="ag ah cw gk">
              <span className="cx fc ce cf b3">
                Norman Y. Mineta San José International Airport (SJC)
              </span>
              <span className="cc fc ce cs cu an cq al">
                1701 Airport Blvd, San Jose
              </span>
            </div>
            <button className="cc cd ce cf jw fr i1 c1 ch b3 ag c5 ci cj ck cl cg">
              Edit
            </button>
          </a>
          <div className="ag">
            <div className="spacer _40"></div>
            <div className="cz h0 aj cw"></div>
          </div>
        </div>
        <div className="cw gk">
          <a
            className="ag qp c1"
            href="/checkout?diningMode=DELIVERY&amp;mod=locationManager&amp;modctx=edit&amp;ps=1"
          >
            <div className="qf">
              <svg
                aria-hidden="true"
              ...
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M14.083 4.917a2.083 2.083 0 11-4.166 0 2.083 2.083 0 014.166 0zm5.417 3.75v2.5h-5v2.5l2.167 7.5h-2.584L12.167 14.5h-.334l-1.916 6.667H7.333l2.167-7.5v-2.5h-5v-2.5h15z"
                ></path>
              </svg>
            </div>
            <div className="ag ah cw gk">
              <span className="cx fc ce cf b3">Meet at door</span>
              <span className="cc cd ce cf dl">Add delivery instructions</span>
            </div>
      ...
      <div className="ag as">
        ...
        <a
          className="cc cd ce cf jw fr r0 c1 ch b3 ag c5 ci cj ck cl cg"
          href="/store/chipotle-mexican-grill-540-newhall-dr-ste-10/Xueo4j6yRTCq1wc5fpOakQ"
        >
          ...
          <div className="cc cd ce cf">Add items</div>
        </a>
      </div>
          ...
          >
            <div className="qc cv">
              <div className="ag as e7">
                <div className="cx fc ce cf b3">Burrito Bowl</div>
